...
<head>
    ...
    <style>
        ...
        .message-box { background: white; padding: 20px; border-left: 4px solid #10b981; margin: 20px 0; border-radius: 5px; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>{{ $applicantName }}</strong> kullanıcısı "<strong>{{ $lfgTitle }}</strong>" başlıklı LFG ilanınıza başvurdu!</p>
            ...
            <p><small>💡 <strong>İpucu:</strong> Başvuruları hızlı değerlendirmek, daha fazla oyuncu çekmenize yardımcı olur!</small></p>
        </div>
        <div class="footer">
