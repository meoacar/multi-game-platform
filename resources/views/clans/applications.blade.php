...
@section('title', 'Başvurular - ' . $clan->name)

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">📋 Klan Başvuruları</h1>
            <p class="text-gray-600">Klan: <span class="font-semibold">{{ $clan->name }}</span></p>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <form action="{{ route('clans.applications.accept', $application->id) }}" method="POST" class="flex-1">
                            @csrf
                            <button type="submit" 
                        ...
                        <form action="{{ route('clans.applications.reject', $application->id) }}" method="POST" class="flex-1">
                            @csrf
                            <button type="submit" 
