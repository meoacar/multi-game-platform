...
@section('title', 'Rol Düzenle: ' . $role->name)
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
            ...
            <span>/</span>
            <a href="{{ route('admin.roles.show', $role->id) }}" class="hover:text-blue-600">{{ $role->name }}</a>
            <span>/</span>
            <span>Düzenle</span>
        </div>
        <h1 class="text-3xl font-bold text-gray-900">Rol Düzenle: {{ $role->name }}</h1>
    </div>
    ...
    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST" class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <input type="text" id="color-text" value="{{ old('color', $role->color) }}" readonly
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon', $role->icon) }}"
                    ...
                    <div class="pt-4 border-t border-gray-200">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex justify-between">
                                <span class="text-gray-600">Kullanıcı Sayısı:</span>
        ...
        <div class="flex items-center justify-between">
            <div>
                <a href="{{ route('admin.roles.show', $role->id) }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                    İptal
                </a>
            </div>
