...
<head>
    ...
    <title>Giriş Yap - PUBG Mobile Topluluk</title>
...
<body class="bg-black text-white min-h-screen overflow-x-hidden">
    ...
    <div class="fixed inset-0 z-0 overflow-hidden bg-black">
        <div class="absolute inset-0" 
             style="background-image: url('/arkaplan/2.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; opacity: 0.15;">
        </div>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5" x-data="{ showPassword: false }">
                    ...
                    <div class="space-y-2">
                        ...
                        <input 
                            ...
                            required 
                            value="{{ old('email') }}"
                            class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                required
                                class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all pr-12"
                                placeholder="••••••••">
                            <button 
                                type="button" 
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="flex items-center cursor-pointer group">
                            ...
                            <span class="ml-2 text-gray-400 group-hover:text-gray-300">Beni hatırla</span>
                        </label>
                    ...
                    <button 
                        type="submit"
                        class="w-full py-3.5 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-blue-500/25">
                        Giriş Yap
                    </button>
                </form>
